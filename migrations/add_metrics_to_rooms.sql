-- Añadir campos para guardar métricas del juego normal y número de carta actual
...
ADD COLUMN IF NOT EXISTS current_card_number INTEGER DEFAULT 0;
...
COMMENT ON COLUMN rooms.current_card_number IS 'Número de carta actual en el juego (1-indexed)';
